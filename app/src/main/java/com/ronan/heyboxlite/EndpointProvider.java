...
final class EndpointProvider {
    ...
    static String mobileLoginCode() { return path(124,50,48,48,60,38,61,39,124,52,54,39,12,63,60,52,58,61,12,48,60,55,54,124); }
    static String mobileLogin() { return path(124,50,48,48,60,38,61,39,124,63,60,52,58,61,12,48,60,55,54,124); }
